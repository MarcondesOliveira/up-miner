<template>
  <div class="container">
    <Header
      ...
      logo="upMiner2"
      title="Mídia e Internet"
      description="Mídia e Internet"
    ...
    <div class="component-body">
      ...
      <div class="linha-do-tempo">
        <hooper :settings="hooperSettings" style="height: 320px">
          <slide >
      ...
      <div class="full_description">
        <p>O aplicativo Mídia e Internet permite ao usuário ter acesso a todos os fatos e acontecimentos relevantes de uma empresa desde o seu ano de fundação. Tenha acesso aos principais eventos corporativos de uma empresa, como: marcos jurídicos, mudança no quadro societário, aumento de capital reportagens e muito mais.</p>
      ...
      <div class="enable">
        <div class="enable__price">
          <p class="enable__price-moeda">R$</p> 
          <p class="enable__price-valor">40,00</p>
          <button class="enable__price-button" href="#">Habilitar</button>
        </div>
      </div>
    </div>
  </div>
...
.enable {
  ...
  .enable__price-button:hover {
    opacity: 0.9;
  }

  .enable__price-button:active {
    color: #fff;
    background-image: linear-gradient(to right, $button-color1, $button-color2);
    border: 0;
    border-radius: 5px;
...
.know {
  ...
  .know__price-button:hover {
    opacity: 0.9;
  }

  .know__price-button:active {
    color: #fff;
    background-image: linear-gradient(to right, $button-color1, $button-color2);
    border: 0;
    border-radius: 5px;
