<template>
  <div class="container">
    <Header
      ...
      description="Listas Restritivas"
    ...
    <div class="component-body">
      ...
      <div class="full_description">
        <p>O aplicativo Listas Restritivas permite ao usuário ter acesso a todos os fatos e acontecimentos relevantes de uma empresa desde o seu ano de fundação. Tenha acesso aos principais eventos corporativos de uma empresa, como: marcos jurídicos, mudança no quadro societário, aumento de capital reportagens e muito mais.</p>
